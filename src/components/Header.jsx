        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-dark-400">Your personal games repository</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2.5 bg-dark-800 hover:bg-dark-700 border border-dark-700 hover:border-dark-600 rounded-xl transition-all group"
              title="Random Picker (R)"
            >
              <svg className="w-5 h-5 text-dark-300 group-hover:text-primary-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                {/* Shuffle */}
            ...
            <button
              ...
              title="Dashboard (D)"
            >
              <svg className="w-5 h-5 text-dark-300 group-hover:text-primary-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative ml-2">
                {loading ? (
                  ...
                  <>
                    ...
                    {showUserMenu && createPortal(
                      <>
                        ...
                        />
                        <div 
                          className="fixed w-64 bg-black/90 backdrop-blur-xl border border-white/10 rounded-xl z-[10000] overflow-hidden animate-fade-in shadow-2xl"
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-white/10 hover:bg-white/15 border border-white/10 rounded-xl transition-all text-sm"
                  ...
                  >
                    ...
                    <span className="text-white hidden sm:inline">Sign in</span>
                  </button>
                )}
              </div>
            )}
            ...
            {firebaseEnabled && !isAuthenticated && !loading && (
              <span className="text-xs text-dark-500 hidden lg:block ml-1">
                to sync
              </span>
            )}
            ...
            <a 
              ...
              className="text-xs text-dark-500 hover:text-primary-400 transition-colors hidden sm:block ml-2"
            >
              Powered by ITAD
            </a>
          </div>
