    ...
    <div className="mt-6 sm:mt-8">
      <nav className="flex gap-2 sm:gap-3">
        ...
        <button
          ...
          className={`
            px-3 sm:px-5 py-2.5 sm:py-3 font-semibold text-xs sm:text-sm transition-all duration-200 rounded-lg sm:rounded-xl flex items-center gap-1.5 sm:gap-2.5 border
            ${activeTab === 'unplayed' 
          ...
          `}
        >
          <svg className={`w-4 h-4 sm:w-5 sm:h-5 ${activeTab === 'unplayed' ? 'text-primary-400' : 'text-dark-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <span>To Play</span>
          <span className={`
            px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-md sm:rounded-lg text-xs font-bold
            ${activeTab === 'unplayed' 
        ...
        <button
          ...
          `}
        >
          <svg className={`w-4 h-4 sm:w-5 sm:h-5 ${activeTab === 'played' ? 'text-green-400' : 'text-dark-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
