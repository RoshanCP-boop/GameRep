export default function FilterBar({ filters, onFiltersChange }) {
  ...
  return (
    <>
      {/* Sort By */}
      <div className="flex items-center gap-2 bg-dark-800 hover:bg-dark-700 border border-dark-700 hover:border-dark-600 px-3 py-2 rounded-xl transition-all cursor-pointer">
      ...
      <button
        ...
        className="flex items-center gap-1.5 bg-dark-800 hover:bg-dark-700 border border-dark-700 hover:border-dark-600 px-3 py-2 rounded-xl text-sm text-dark-200 hover:text-white transition-all"
